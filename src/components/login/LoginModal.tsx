          ...
          <div className={styles['inner-wrapper']}>
            ...
            <form className={styles['form']}>
              ...
              <div className={styles['form-control']}>
                <label className={styles['floating-label']} htmlFor='phone-number'>Số điện thoại</label>
                <input id='phone-number' type='tel' inputMode='numeric' />
                <span className={styles['floating-label']}>Số điện thoại</span>
              </div>
              <div className={styles['form-control']}>
            ...
            <div className={styles['login-alternatives']}>
              ...
              <span className={styles['middle-title']}>
                hoặc đăng nhập bằng
              </span>
