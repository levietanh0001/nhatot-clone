      ...
      <div className='container'>
        <div className={styles['wrapper']}>
          ...
          <div className={'mua-ban-bds-carousel'}>
            ...
            >
              {
                slides.map((slide, index) => (
                  <SwiperSlide>
                    <Card title='Cần bán bất động sản nhất cận thị nhị cận sông' {...slide}>
            ...
            <button className="prev-mua-ban" onClick={() => prevRef.current?.click()}>
              <KeyboardArrowLeft fontSize='medium' />
            </button>
            <button className="next-mua-ban" onClick={() => nextRef.current?.click()}>
              <KeyboardArrowRight fontSize='medium' />
            </button>
          </div>
