...
import styles from "./ChoThueBDS.module.scss";
import "./ChoThueBDSCarousel.scss";
import ICardProps from "./carousel-card-interface";
      ...
      <div className="container">
        <div className={styles["wrapper"]}>
          ...
          <div className={"cho-thue-bds-carousel"}>
            ...
            >
              {
                slides.map((slide, index) => (
                  <SwiperSlide>
                    <Card title='Cần cho thuê căn góc ban công đông đông nam' {...slide}>
                      <span>65-70 m<sup>2</sup></span>
                      <span className={styles['price']}>8 triệu/tháng</span>
                      <footer>
            ...
            <button
              className="prev-cho-thue"
              onClick={() => prevRef.current?.click()}
            >
              <KeyboardArrowLeft fontSize="medium" />
            </button>
            <button
              className="next-cho-thue"
