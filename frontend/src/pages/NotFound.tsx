...
const NotFound = () => {
  return (
    <>
      ...
      <body style={{ backgroundColor: 'var(--secondary-background-color)', marginBottom: '15px' }}>
        <div className='container'>
          <div
            ...
            <div className="warning" style={{ marginBottom: '30px' }}>
              <h1 style={{ textAlign: 'center', fontSize: '1.25rem', fontWeight: 600, margin: 0 }}>
                Lỗi - Không tìm thấy trang
              </h1>
              <p style={{ textAlign: 'center', fontSize: '1rem', margin: 0, marginTop: '7px' }}>
                Trang bạn đang tìm không tồn tại. Vui lòng kiểm tra lại đường dẫn
                hoặc bấm 'Quay về trang chủ'
              </p>
            </div>
