  ...
  return (
    <div className='container'>
        ...
        <div className={styles['options']}>
          <div className={styles['option']} onClick={() => onCategoryChange('')}>
          ...
          <div className={styles['option']} onClick={() => onCategoryChange('canhochungcu')}>
          ...
          <div className={styles['option']}  onClick={() => onCategoryChange('nhao')}>
          ...
          <div className={styles['option']}  onClick={() => onCategoryChange('khac')}>
