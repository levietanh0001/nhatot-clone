...
import SidebarAccordionMenuItem from './SidebarAccordionMenuItem';
...
const SidebarAccordionMenu = () => {
  ...
  const parentItems = sidebarMenuItems.filter((item) => {
    if (item.isTitle) {
      return item;
    }
  });
    ...
    <ul className={styles['accordion-menu']}>
      {parentItems.map((item, index) => (
        <SidebarAccordionMenuItem
          ...
          onCurrentItemSelect={(id) => setCurrentItem(id)}
          {...item}
        />
      ))}
    </ul>
...
export const sidebarMenuItems = [
  ...
  },
  {
    ...
    directDescendants: ['users-list', 'products-lists'],
  },
  {
    label: 'Users',
    id: 'users-list',
  ...
  },
  {
    ...
    directDescendants: ['users-analytics', 'products-analytics'],
  },
  {
    label: 'Users',
    id: 'users-analytics',
