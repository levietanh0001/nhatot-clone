      ...
      <ClickAwayListener onClickAway={() => setShow(false)}>
        <div className={styles['dropdown-menu']} onClick={() => setShow(!show)}>
          ...
          <div className={styles['menu-btn']}>
            <span>
              {productType === 'chothue' ? 'Cho thuê' : productType === 'duan' ? 'Dự án' : 'Mua bán'}
            </span>
          ...
          {show && (
            <div className={styles['menu-content']}>
              <div className={styles['menu-item']} onClick={() => setProductType('muaban')}>
                <span>Mua bán</span>
                <svg style={{ visibility: productType === 'muaban' ? 'initial' : 'hidden' }} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" /></svg>
              </div>

              <div className={styles['menu-item']} onClick={() => setProductType('chothue')}>
                <span>Cho thuê</span>
                <svg style={{ visibility: productType === 'chothue' ? 'initial' : 'hidden' }} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" /></svg>
              </div>

              <div className={styles['menu-item']} onClick={() => setProductType('duan')}>
                <span>Khác</span>
                <svg style={{ visibility: productType === 'duan' ? 'initial' : 'hidden' }} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" /></svg>
              </div>
    ...
    <div className={styles['search-box']}>
      ...
      {searchInput && (
        <span onClick={() => setSearchInput('')}>
          <svg xmlns="http://www.w3.org/2000/svg" height="0.75em" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM175 175c9.4-9.4 24.6-9.4 33.9 0l47 47 47-47c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-47 47 47 47c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-47-47-47 47c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l47-47-47-47c-9.4-9.4-9.4-24.6 0-33.9z" /></svg>
        </span>
      )}
      <div className={styles['search-btn']}>
        <button>
          <svg color='white' xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" /></svg>
        </button>
      </div>
    </div>
  );
