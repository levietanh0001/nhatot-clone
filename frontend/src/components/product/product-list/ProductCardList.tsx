...
const placeholderImageSrc =
  'https://placehold.co/210x163/orange/white/png?text=Nh%C3%A0%20T%E1%BB%91t';
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <button
                      onClick={() => onFavoriteButtonClick(product.details.id)}
                    ...
                    >
                      <span className={styles['heart-icon']}>
                        ...
                        {favoriteProductIds &&
                          !favoriteProductIds.includes(product.details.id) && (
                            <svg
                              xmlns='http://www.w3.org/2000/svg'
                              height='1em'
                              viewBox='0 0 512 512'
