        ...
        <div className={className}>
          ...
          >
            {slides.map((slide, index) => (
              <SwiperSlide>
                <Card
                  title='Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolore eum dolorem laborum nemo iste, facere veritatis enim magnam autem, deserunt est non odio adipisci veniam aut rem incidunt in quia.'
                  {...slide}
                >
                  <span>
                    65-70 m<sup>2</sup>
