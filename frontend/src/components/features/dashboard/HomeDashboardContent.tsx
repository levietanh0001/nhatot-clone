    ...
    <>
      <div className={styles['wrapper']}>
        ...
        <div className={styles['grid']}>
          ...
          <Paper className={styles['latest-products']} elevation={3} sx={{ padding: '20px', backgroundColor: '#202020', borderRadius: '12px' }}>
          ...
          <Paper className={styles['total-users']} elevation={3} sx={{ padding: '20px', backgroundColor: '#202020', borderRadius: '12px' }}>
            <div className={styles['title-wrapper']}>
              <span className={styles['icon']}>
          ...
          <Paper className={styles['total-products']} elevation={3} sx={{ padding: '20px', backgroundColor: '#202020', borderRadius: '12px' }}>
            <div className={styles['title-wrapper']}>
              <span className={styles['icon']}>
          ...
          <Paper className={styles['activities']} elevation={3} sx={{ padding: '20px', backgroundColor: '#202020', borderRadius: '12px' }}>
            <div className={styles['title-wrapper']}>
              <span className={styles['icon']}>
          ...
          <Paper className={styles['users-by-role']} elevation={3} sx={{ padding: '20px', backgroundColor: '#202020', borderRadius: '12px' }}>
            <div className={styles['title-wrapper']}>
              <span className={styles['icon']}>
          ...
          <Paper className={styles['products-by-type']} elevation={3} sx={{ padding: '20px', backgroundColor: '#202020', borderRadius: '12px' }}>
            <div className={styles['title-wrapper']}>
              <span className={styles['icon']}>
          ...
          <Paper className={styles['products-by-category']} elevation={3} sx={{ padding: '20px', backgroundColor: '#202020', borderRadius: '12px' }}>
            <div className={styles['title-wrapper']}>
              <span className={styles['icon']}>
